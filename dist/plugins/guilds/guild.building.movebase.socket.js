...
exports.event = 'plugin:guild:building:movebase';
exports.description = 'Move the guild to a new place.';
exports.args = 'newBase';
exports.socket = (socket, primus, respond) => {
    const request = ({ newBase }) => __awaiter(this, void 0, void 0, function* () {
        if (!socket.authToken)
            return;
        ...
        if (!player || !player.guild || player.guild.$noGuild)
            return;
        logger_1.Logger.info('Socket:Guild:Building:MoveBase', `${playerName} (${socket.address.ip}) moving to ${newBase}.`);
