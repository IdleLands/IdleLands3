...
exports.event = 'plugin:guild:tax';
exports.description = 'Update your guilds tax rate.';
...
exports.socket = (socket) => {
    const request = ({ newRate }) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player)
            return;
        logger_1.Logger.info('Socket:Guild:TaxRate', `${playerName} (${socket.address.ip}) setting guild tax rate to ${newRate}%.`);
