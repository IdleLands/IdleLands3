...
exports.event = 'plugin:guild:create';
exports.description = 'Create a new guild.';
...
exports.socket = (socket, primus, respond) => {
    const request = ({ name, tag }) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player)
            return;
        logger_1.Logger.info('Socket:Guild:Create', `${playerName} (${socket.address.ip}) creating guild ${name} [${tag}].`);
