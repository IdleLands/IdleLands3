...
exports.event = 'plugin:guild:building:upgrade';
exports.description = 'Upgrade a building in the guild.';
exports.args = 'buildingName';
exports.socket = (socket, primus, respond) => {
    const request = ({ buildingName }) => __awaiter(this, void 0, void 0, function* () {
        if (!socket.authToken)
            return;
        ...
        if (!player || !player.guild || player.guild.$noGuild)
            return;
        logger_1.Logger.info('Socket:Guild:Building:Build', `${playerName} (${socket.address.ip}) upgrading ${buildingName}.`);
