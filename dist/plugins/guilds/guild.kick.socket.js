...
exports.event = 'plugin:guild:kick';
exports.description = 'Kick someone from your guild.';
...
exports.socket = (socket, primus, respond) => {
    const request = ({ memberName }) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player || !player.guild || player.guild.$noGuild)
            return;
        logger_1.Logger.info('Socket:Guild:Kick', `${playerName} (${socket.address.ip}) kicking ${memberName}.`);
