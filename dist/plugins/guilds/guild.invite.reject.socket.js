...
exports.event = 'plugin:guild:invite:reject';
exports.description = 'Reject a guild invitation.';
exports.args = '';
exports.socket = (socket, primus, respond) => {
    const request = () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player)
            return;
        logger_1.Logger.info('Socket:Guild:InviteReject', `${playerName} (${socket.address.ip}) rejecting guild invite.`);
