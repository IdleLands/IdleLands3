...
exports.event = 'plugin:guild:motd';
exports.description = 'Update your guilds MOTD.';
exports.args = 'motd';
exports.socket = (socket, primus, respond) => {
    const request = ({ motd }) => __awaiter(this, void 0, void 0, function* () {
        if (!socket.authToken)
            return;
        ...
        if (!player || !player.guild || player.guild.$noGuild)
            return;
        logger_1.Logger.info('Socket:Guild:MOTD', `${playerName} (${socket.address.ip}) changing guild MOTD to ${motd}%.`);
