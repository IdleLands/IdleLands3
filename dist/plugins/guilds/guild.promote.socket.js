...
exports.event = 'plugin:guild:promote';
exports.description = 'Promote a member to Mod status.';
...
exports.socket = (socket, primus, respond) => {
    const request = ({ memberName }) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player || !player.guild || player.guild.$noGuild)
            return;
        logger_1.Logger.info('Socket:Guild:Promote', `${playerName} (${socket.address.ip}) promoting ${memberName}.`);
