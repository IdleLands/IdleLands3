...
exports.event = 'plugin:guild:invite:accept';
exports.description = 'Accept a guild invitation.';
exports.args = '';
exports.socket = (socket, primus, respond) => {
    const request = () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player)
            return;
        logger_1.Logger.info('Socket:Guild:InviteAccept', `${playerName} (${socket.address.ip}) accepting guild invite.`);
