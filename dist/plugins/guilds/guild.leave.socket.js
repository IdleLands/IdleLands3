...
exports.event = 'plugin:guild:leave';
exports.description = 'Leave your guild.';
exports.args = '';
exports.socket = (socket, primus, respond) => {
    const request = () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!player || !player.guild || player.guild.$noGuild)
            return;
        logger_1.Logger.info('Socket:Guild:Leave', `${playerName} (${socket.address.ip}) leaving guild.`);
